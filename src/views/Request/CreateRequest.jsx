...
class CreateRequest extends Component {
  ...
  intialize(props) {
    ...
    this.GetStatus();
    this.GetKeyValue();
    this.setState({ parentId: ParentId, uploadedFiles: [], IsSubmitDisable: false, show: show });
    files = [];
    DocComments = [];
    Documents = [];
    totalSizeInMB = 0;
    ...
    return (
      <>
        ...
        >
          ...
          <Modal.Footer>
            <ButtonToolbar>
              <Button variant="light" onClick={this.ResetStateValues.bind(this)}>Cancel</Button>&nbsp;&nbsp;
         <Button variant="primary" name="btnSubmit" disabled={this.state.IsSubmitDisable} closeButton onClick={this.create.bind(this)} >Submit</Button>
            </ButtonToolbar>
          </Modal.Footer>
